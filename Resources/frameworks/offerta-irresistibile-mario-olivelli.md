...
type: framework
status: active
tags: [framework, marketing, offerta, traffico, vendita]
---

Framework di [[Mario Olivelli]] su come costruire un'offerta irresistibile, governare le fonti di traffico e vendere in modo consulenziale, presentato nel webinar di vendita del suo percorso a pagamento Info Business Arena. Raw completo in `Library/videos/mario-olivelli-info-business-arena-webinar.txt` (+ mind map allegata).

> [!info] Quattro pezzi del sistema
> Offerta → Traffico → Sistema di convinzioni → Vendita. Nell'ordine: costruire prima l'offerta (se non si vende facilmente, nessun funnel o campagna la salva), poi portarci traffico governabile, poi installare le idee giuste prima della call, infine vendere in modo consulenziale, non a spinta.
...
Prima di portare traffico verso l'offerta, il prospect deve interiorizzare quattro idee, nell'ordine, distribuite in tutti i touchpoint (contenuti, mail, ads, pagine, presentazioni dal vivo) e non solo dentro un funnel lineare:

1. È possibile ottenere il risultato (in generale)
2. È possibile che ci riesca proprio io
3. Le abilità necessarie si possono imparare (non serve essere "portati")
...
- Garanzia "90+90": se non si acquisiscono clienti in 90 giorni, supporto gratuito per altri 90
- Vendita in webinar con acconto immediato + call di qualificazione con un consulente

> [!warning] Da non confondere con consulenza fatta ad HACCP Digitale
> Questo webinar è un contenuto osservato da [[Antonio Malatesta]] per apprendimento, distinto dalla consulenza privata diretta di Mario Olivelli sul funnel di HACCP Digitale (vedi [[2026-09-08-consulenza-mario-olivelli-funnel-lead-gen]] e [[funnel-questionario-ghl]]). Le tattiche di scarcity/urgenza e il prezzo a 4-5 cifre di Info Business Arena non sono applicabili al posizionamento di [[brand]] di HACCP Digitale (niente hype, niente urgenza finta).
