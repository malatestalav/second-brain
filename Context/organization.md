...
## Azienda
- **Nome legale:** Nexvision S.r.l.
- **Settore:** Digitalizzazione processi aziendali, specializzato in HACCP
- **Fase:** Startup appena lanciata (20 giorni dal lancio)
- **Dimensione:** 3 persone (2 fondatori + 1 commerciale)
- **Fondata:** 2026 (agosto)

## Missione e Valori
- **Missione:** Semplificare i processi aziendali in un ristorante
- **Valore core:** Titolari devono concentrarsi su cibo e clienti, non su burocrazia cartacea
...
Attualmente piatta:
- **Antonio Malatesta** (Founder): Strategia generale, marketing, acquisizione
- **[[Vito Romano]]** (Socio, Cugino): Amministrazione, marketing, supporto acquisizione
- **[[Antonio Smaldini]]** (Commerciale, Partita IVA): Outreach e chiusura contratti

Nessun dipartimento formale ancora. Team piccolo e agile.
