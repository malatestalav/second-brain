...
- **ManyChat:** Non ancora attivo, da configurare **per ultimo**, subito prima del lancio (decisione 2026-09-14: prima si producono contenuti e struttura dei tre funnel, l'account si crea alla fine). Ruolo confermato: automazione commento→DM per il [[piano-editoriale-instagram-3-funnel|funnel freddo Instagram]] (consegna della [[lead-magnet-checklist-punti-critici|checklist punti critici]]), al posto di GHL. È Meta Business Partner ufficiale, si collega via API ufficiale Instagram, il commento stesso conta come interazione valida per aprire la finestra DM (nessun vincolo delle 24h precedenti come in GHL). Limite dell'API di Meta, comune a tutti gli strumenti: non può scrivere per primo a chi non ha mai interagito.
  - **Analytics ManyChat (verificato 2026-09-14):** non è un CRM/pipeline come GHL. Dà solo un Insights dashboard generale (iscritti, interazioni recenti) e Flow analytics per automazione (volte in cui il trigger commento è scattato, tasso di apertura/click del DM). Non collega da solo "chi ha ricevuto la checklist" a un lead nel funnel caldo. **In sospeso il 2026-09-14:** [[Antonio Malatesta]] si farà consigliare da [[Mario Olivelli]] su come sfruttare al meglio questi dati prima di decidere l'integrazione col tracker di [[lead-gen-instagram-organico]]. Fonte: [Manychat, Ultimate Guide Instagram Comment Automation](https://manychat.com/blog/the-ultimate-guide-for-instagram-comment-automation/), [Understanding analytics | Manychat](https://community.manychat.com/general-q-a-43/understanding-analytics-9614). Resta da: creare account, collegare la pagina Instagram, configurare il workflow con parola chiave "CHECKLIST".
