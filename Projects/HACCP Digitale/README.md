...
- [Spec funnel questionario + GHL](specs/funnel-questionario-ghl.md) . pagina unica a scroll continuo con barra fissa (opt-in di vendita → questionario → video demo → contatti per analisi gratuita dei punti critici) collegata alla CTA del video; **opt-in page completata e funzionante sia da desktop che da mobile** (2026-09-10), prossimo step: pubblicazione online e revisione dell'automazione di notifica lead
