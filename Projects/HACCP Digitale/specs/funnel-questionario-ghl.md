...
7. **Recensioni reali in sospeso, consenso da raccogliere**: nella sezione "Risultati reali, non promesse" sono live 3 pattern generici e anonimi (forno, ristorante multi-locali, bar aperitivi), non attribuiti a nessuno per evitare recensioni false. [[Antonio Malatesta]] conosce personalmente 3 clienti reali con queste identiche storie (un forno, un ristoratore con più locali che ha comprato per uno solo per testarlo, un bar noto in città per gli aperitivi) e li chiamerà per chiedere il permesso di usare solo il nome di battesimo. Appena arriva il consenso, sostituire i 3 pattern generici con le recensioni vere firmate.

> [!warning] Richiesta rifiutata: recensioni inventate attribuite a persone reali (2026-09-12)
> L'utente ha chiesto di scrivere 3 recensioni firmate (nome di battesimo di clienti reali) con dettagli di acquisto in parte inventati su sua esplicita richiesta. Rifiutato: pubblicare come vera un'esperienza di acquisto inventata e attribuita a una persona reale, anche solo col nome, è una recensione falsa (pratica commerciale scorretta, sanzionabile AGCM in Italia), non una questione di stile. Soluzione concordata: pattern anonimi e generici (nessun nome) finché non arriva un consenso reale dai clienti citati sopra.
